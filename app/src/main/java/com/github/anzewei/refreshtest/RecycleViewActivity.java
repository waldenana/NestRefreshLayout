...
public class RecycleViewActivity extends BaseControlActivity implements OnPullListener {
    ...
    private MyItemRecyclerViewAdapter.OnListFragmentInteractionListener mListener = new MyItemRecyclerViewAdapter.OnListFragmentInteractionListener() {
        ...
        public void onListFragmentInteraction(DummyContent.DummyItem item) {
            Toast.makeText(RecycleViewActivity.this, item.content, Toast.LENGTH_SHORT).show();
        }
    };
