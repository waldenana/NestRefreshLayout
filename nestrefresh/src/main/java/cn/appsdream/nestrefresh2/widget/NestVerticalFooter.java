...
public class NestVerticalFooter extends RelativeLayout implements IHeaderFooter {
    ...
    public NestVerticalFooter(Context context) {
       this(context,null);
    }

    public NestVerticalFooter(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public NestVerticalFooter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHintTextView = (TextView) findViewById(R.id.footer_hint_textview);
        ...
        mHintTextView.setTextAppearance(getContext(),a.getResourceId(R.styleable.RefreshLayout_footerTextAppearance,android.R.style.TextAppearance));
        a.recycle();
    ...
    public void onParentScrolled(RefreshLayout parent, int dx, int dy) {
        ...
        if (mStatus == STATE_NORMAL && parent.getNestedScrollY() >= mMiniPull) {
            setState(STATE_READY);
        }else if (mStatus == STATE_READY && parent.getNestedScrollY() < mMiniPull){
    ...
    public View getView(RefreshLayout parent) {
        ...
        if (params == null) {
            params = new RefreshLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mMiniPull/2);
