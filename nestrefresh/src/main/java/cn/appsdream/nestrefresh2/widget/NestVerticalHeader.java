...
public class NestVerticalHeader extends RelativeLayout implements IHeaderFooter {
    ...
    public NestVerticalHeader(Context context) {
        this(context, null);
    }

    public NestVerticalHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestVerticalHeader(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        ViewCompat.setRotation(mCircleView,getBottom()*180/getMeasuredHeight());
        moveSppiner(parent.getNestedScrollY());
        if (mState == STATE_READY && -parent.getNestedScrollY() < mMiniPull) {
            setState(STATE_NORMAL);
        } else if (mState == STATE_NORMAL && -parent.getNestedScrollY() > mMiniPull) {
