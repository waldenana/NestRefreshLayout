 ...
 * <p/>
 */
package com.github.anzewei.pagelist.matetialstyle;
...
public class MaterialPageListLoader extends AbsListLoader {
    ...
    public MaterialPageListLoader(Context context) {
        this(context, null);
    }

    public MaterialPageListLoader(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.materiaProgressBarStyle);
    }

    public MaterialPageListLoader(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle);
    }

    public MaterialPageListLoader(View listView) {
        super(listView);
