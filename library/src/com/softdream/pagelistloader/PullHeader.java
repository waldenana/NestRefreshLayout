 ...
 * Update Date:
 */
public class PullHeader extends RelativeLayout implements PageListLoader.LoaderDecor {
     ...
     * @param defStyle
     */
    public PullHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaint.setTextSize(mHintTextView.getTextSize());
